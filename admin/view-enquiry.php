...
<a href="SendEmailFromLocalhost/sendingmail"><button>Send mail</button></a>

<!--<input type="submit" onClick="myfuction()"/>-->

<!--<input type="submit"  href="sendingMail" value="Send An Email" > -->
                            </div>
	...
	function myfuction()
	{
		window.location.href="C:\wamp64\www\buspassms\admin";
	}
